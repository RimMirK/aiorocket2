...
class App:
    ...
    async def send_transfer(
        ...
        Args:
            tg_user_id (int): Telegram user ID. If we dont have this user in DB, we will fail \
                transaction with error: 400 - User not found
    ...
    async def create_withdrawal(
        ...
        Args:
            ...
            address (str): Withdrawal address. E.g. \
